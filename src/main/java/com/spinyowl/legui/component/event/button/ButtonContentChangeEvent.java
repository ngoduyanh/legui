...
public class ButtonContentChangeEvent extends Event<Button> {
  ...
  public ButtonContentChangeEvent(Button component, GLFWContext context, Frame frame, String oldValue,
                                  String newValue) {
  ...
  public boolean equals(Object o) {
    ...
    ButtonContentChangeEvent that = (ButtonContentChangeEvent) o;
